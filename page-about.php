...
<section class="section section--padded section-team pd-top--big pd-bottom--big" id="team">
  <div class="container--tight">
    ...
    ?>
    <img src="<?php echo $image[0]; ?>" alt="SEAD Team" class="team__img">
  </div>
</section>
    ...
    <div class="columns">
      ...
      <div class="column">
        <div class="icon-box text--light">
          ...
          ?>
          <img src="<?php echo $partner_icon[0]; ?>" alt="Partner - <?php the_field('partner_1_title'); ?>" class="icon-box__icon">
      ...
      <div class="column">
        <div class="icon-box text--light">
          ...
          $partner_icon = wp_get_attachment_image_src($partner_id_icon, 'full');
          ?>
          <img src="<?php echo $partner_icon[0]; ?>" alt="Partner - <?php the_field('partner_2_title'); ?>" class="icon-box__icon">
      ...
      <div class="column">
        <div class="icon-box text--light">
          ...
          $partner_icon = wp_get_attachment_image_src($partner_id_icon, 'full');
          ?>
          <img src="<?php echo $partner_icon[0]; ?>" alt="Partner - <?php the_field('partner_3_title'); ?>" class="icon-box__icon">
