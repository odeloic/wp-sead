...
<section class="section pd-top--big pd-bottom--big">
    ...
    <div class="container--tight">
        ...
        <form action="https://formspree.io/mdozarkr" method="POST" class="sd-contact-form">
            ...
            <div class="sd-contact-form__body">
                ...
                <div class="sd-contact-form__row">
                    ...
                    <div class="sd-contact-form__group">
                        <input type="text" class="sd-contact-form__input" name="name" required>
                        <label for="fullName" class="sd-contact-form__label">*Full Name</label>
                    </div><!-- input group -->

                    <div class="sd-contact-form__group">
                        <input type="email" class="sd-contact-form__input" name="_replyto" required>
