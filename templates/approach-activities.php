                ...
                <div class="columns">
                    <div class="column core">
                        <?php
                          ...
                          $icon = wp_get_attachment_image_src($icon_id, 'full');
                           ?>
                        ?>
                        <img src="<?php echo $icon[0]; ?>" alt="" class="core__icon">
                    ...
                    <div class="column">
                        <div class="overlap-images">
                            <?php
                            // Back Image
                            $back_image_id = get_field('sead_overlap_image_back');
                            $back_image = wp_get_attachment_image_src($back_image_id, 'full');
                            // Front Image
                            $front_image_id = get_field('sead_overlap_image_front');
                            $front_image = wp_get_attachment_image_src($front_image_id, 'full');
                            ?>
                            <img src="<?php echo $back_image[0]; ?>" alt="">
                            <img src="<?php echo $front_image[0]; ?>" alt="">
                        </div>
                    </div>
