<div class="swiper-slide activities-slider__activity">
    ...
    ?>
    <img src="<?php echo $activity_background_image[0]; ?>" alt="" class="activities-slider__activity__img">
    <div class="activities-slider__activity__details">
        ...
        ?>
        <img src="<?php echo $activity_icon[0]; ?>" alt="" class="activities-slider__activity__icon">
